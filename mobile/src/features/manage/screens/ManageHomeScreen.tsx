    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          <Text style={[styles.headerLabel, { color: colors.textSecondary }]}>Manage</Text>
          <Text style={[styles.headerTitle, { color: colors.text }]}>Your Records</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  headerLabel: { ...typography.label, textTransform: 'uppercase', marginBottom: spacing.xs },
  headerTitle: { ...typography.h2 },
  grid: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm },
  card: { width: '48%', borderRadius: radius.lg, padding: spacing.md, gap: spacing.sm, borderWidth: 1, ...shadows.sm },
